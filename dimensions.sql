...
--
-- Client: localhost
-- Généré le: Mar 09 Juin 2015 à 17:21
...
(1, 1, 'pack2-appart-expo-00', 'L''appart''Expo est un projet d''agencement et de décoration pour un appartement.<br>\nLes clients sont un jeune couple d''une trentaine d''années, la femme est artiste et l''homme est pompier. Ils aiment les matériaux durables, les couleurs vives et sont assez sensibles au respect de l''environnement.<br>\nLe projet proposé est une exposition des œuvres de madame comme une galerie d''art dans leur propre appartement avec des allusions aux milieux professionnels (des spots, des fiches signalétiques, une salle de bain ressemblant aux toilettes publique).<br>\nTout ça avec des couleurs comme ils le désiraient et des matériaux durables et écologiques (des sols en liège et en linoleum, des peintures écologiques et des mobiliers principalement en bois).'),
(2, 1, 'pack2-appart-expo-01', 'Planche d''inspiration'),
(3, 1, 'pack2-appart-expo-02', 'Planche d''ambiance'),
(4, 1, 'pack2-appart-expo-03', 'Visuel 3D de l''appartement'),
(5, 1, 'pack2-appart-expo-04', 'Visuel 3D de l''appartement - Chambre et bureau'),
(6, 1, 'pack2-appart-expo-05', 'Visuel 3D de l''appartement - Salon vu de la salle à manger'),
(7, 1, 'pack2-appart-expo-06', 'Visuel 3D de l''appartement - Salon vu de l''entrée'),
(8, 1, 'pack2-appart-expo-07', 'Visuel 3D de l''appartement - Salle à manger et cuisine'),
(9, 1, 'pack2-appart-expo-08', 'Perspective fait à la main - Salle à manger et cuisine'),
(10, 1, 'pack2-appart-expo-09', 'Plan avant travaux'),
...
(27, 2, 'pack1-lainemoi-13', 'Maquette du site mobile'),
(28, 3, 'pack2-ppc-01', 'Logo "P''tits pois carottes"'),
(29, 3, 'pack2-ppc-02', 'Logo "P''tits pois carottes"'),
(30, 3, 'pack2-ppc-03', 'Logo "P''tits pois carottes"'),
(31, 3, 'pack2-ppc-04', 'Kit print'),
(32, 3, 'pack2-ppc-05', 'Enseigne'),
(33, 3, 'pack2-ppc-06', 'Sac'),
(34, 3, 'pack2-ppc-07', 'Typographie, couleurs et logo');
